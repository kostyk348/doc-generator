...
Офлайн-генератор официальных документов АО «НПО «Тепломаш»: исходящие письма, служебные записки и бланки по ГОСТ, с автозаполнением реквизитов, склонением ФИО и должностей, единым реестром исходящих и экспортом в PDF/.eml/.doc.
...
- **ГОСТ-шапка на бланке Тепломаш** — официальный логотип, реквизиты, фиксированные поля
...
- **Справочник сотрудников** Тепломаш — выбор адресата/составителя, подстановка должности (в дательном падеже) и отдела
...
© АО «НПО «Тепломаш». Внутреннее ПО, не для публичного распространения.